...
DEFAULT_deploy_genefi_bin="/usr/local/bin/gen-efi"
DEFAULT_deploy_user_setup_bin="/usr/local/bin/shani-user-setup"
DEFAULT_deploy_log_file="/var/log/shanios-deploy.log"
DEFAULT_deploy_channel_file="/etc/shani-channel"
DEFAULT_health_gpg_signing_key="7B927BFFD4A9EAAA8B666B77DE217F3DA8014792"
DEFAULT_health_gpg_signing_key_file="/etc/shani-keys/signing.asc"
DEFAULT_health_data_boot_ok="/data/boot-ok"
DEFAULT_health_data_boot_fail="/data/boot_failure"
DEFAULT_health_data_boot_fail_acked="/data/boot_failure.acked"
DEFAULT_health_data_boot_hard_fail="/data/boot_hard_failure"
DEFAULT_health_data_current_slot="/data/current-slot"
DEFAULT_health_data_prev_slot="/data/previous-slot"
DEFAULT_health_data_deploy_pending="/data/deployment_pending"
DEFAULT_health_data_reboot_needed="/run/shanios/reboot-needed"
...
readonly GENEFI_BIN="${deploy_genefi_bin:-${DEFAULT_deploy_genefi_bin}}"
readonly USER_SETUP_BIN="${deploy_user_setup_bin:-${DEFAULT_deploy_user_setup_bin}}"
readonly DEPLOY_LOG="${deploy_log_file:-${DEFAULT_deploy_log_file}}"
readonly CHANNEL_FILE="${deploy_channel_file:-${DEFAULT_deploy_channel_file}}"
readonly GPG_SIGNING_KEY="${health_gpg_signing_key:-${DEFAULT_health_gpg_signing_key}}"
readonly GPG_SIGNING_KEY_FILE="${health_gpg_signing_key_file:-${DEFAULT_health_gpg_signing_key_file}}"
readonly DATA_BOOT_OK="${health_data_boot_ok:-${DEFAULT_health_data_boot_ok}}"
readonly DATA_BOOT_FAIL="${health_data_boot_fail:-${DEFAULT_health_data_boot_fail}}"
readonly DATA_BOOT_FAIL_ACKED="${health_data_boot_fail_acked:-${DEFAULT_health_data_boot_fail_acked}}"
readonly DATA_BOOT_HARD_FAIL="${health_data_boot_hard_fail:-${DEFAULT_health_data_boot_hard_fail}}"
readonly DATA_CURRENT_SLOT="${health_data_current_slot:-${DEFAULT_health_data_current_slot}}"
readonly DATA_PREV_SLOT="${health_data_prev_slot:-${DEFAULT_health_data_prev_slot}}"
readonly DATA_DEPLOY_PENDING="${health_data_deploy_pending:-${DEFAULT_health_data_deploy_pending}}"
readonly DATA_REBOOT_NEEDED="${health_data_reboot_needed:-${DEFAULT_health_data_reboot_needed}}"
