...
DEFAULT_deploy_boot_fail="/data/boot_failure"
DEFAULT_deploy_boot_fail_acked="/data/boot_failure.acked"
DEFAULT_deploy_boot_hard_fail="/data/boot_hard_failure"
...
readonly DATA_BOOT_OK="${deploy_boot_ok:-${DEFAULT_deploy_boot_ok}}"
readonly DATA_BOOT_FAIL="${deploy_boot_fail:-${DEFAULT_deploy_boot_fail}}"
readonly DATA_BOOT_FAIL_ACKED="${deploy_boot_fail_acked:-${DEFAULT_deploy_boot_fail_acked}}"
readonly DATA_BOOT_HARD_FAIL="${deploy_boot_hard_fail:-${DEFAULT_deploy_boot_hard_fail}}"
readonly DATA_CURRENT_SLOT="${deploy_current_slot:-${DEFAULT_deploy_current_slot}}"
readonly DATA_PREV_SLOT="${deploy_prev_slot:-${DEFAULT_deploy_prev_slot}}"
readonly DATA_DEPLOY_PENDING="${deploy_pending:-${DEFAULT_deploy_pending}}"
readonly DATA_REBOOT_NEEDED="${deploy_reboot_needed:-${DEFAULT_deploy_reboot_needed}}"
