...
DEFAULT_deploy_base_url="https://sourceforge.net/projects/shanios/files"
DEFAULT_deploy_channel_file="/etc/shani-channel"
DEFAULT_deploy_current_slot_file="/data/current-slot"
DEFAULT_deploy_boot_failure_file="/data/boot_failure"
DEFAULT_deploy_boot_hard_failure_file="/data/boot_hard_failure"
DEFAULT_deploy_boot_ok_file="/data/boot-ok"
...
BASE_URL="${deploy_base_url:-${DEFAULT_deploy_base_url}}"
CHANNEL_FILE="${deploy_channel_file:-${DEFAULT_deploy_channel_file}}"
CURRENT_SLOT_FILE="${deploy_current_slot_file:-${DEFAULT_deploy_current_slot_file}}"
...
BOOT_OK_FILE="${deploy_boot_ok_file:-${DEFAULT_deploy_boot_ok_file}}"
